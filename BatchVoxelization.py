...
if __name__ == "__main__":
    ...
    np.save("test0001/PC.npy",PC)
    np.save("test0001/PC1.npy",PC1)
    np.save("test0001/PC2.npy",PC2)
    np.save("test0001/VoxelPC.npy",VoxelPC)
    np.save("test0001/SingleColor0.npy",SingleColor0)
    np.save("test0001/SingleColor1.npy",SingleColor1)
    np.save("test0001/color1.npy",color1)
    np.save("test0001/color2.npy",color2)
