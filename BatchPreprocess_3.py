...
def BatchCorrectPC(strSequence, Frames, iProc,  iThread, flags4MultiProc):
    oriDataBaseDir = '/home/zhang/workspace/CAE-LO/KITTI_odometry/velodyne/sequences/'
    curDataBaseDir = '/home/zhang/workspace/CAE-LO/KITTI_odometry/velodyne/sequences/'
    rawDataFolderName = 'velodyne'
...
if __name__ == "__main__":
    ...
    print("-----------------------------------------")
    print("RespondImg shape and type", RespondImg.shape, type(RespondImg))
    t2=time()
